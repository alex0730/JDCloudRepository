...
// Adds new dictionary variables/methods to the class's prototype.
...
function extendClass(superClass, members) {
	...
	// copy each dictionary variable/method onto the the subclass's prototype
	...
	var ListenerMixin = {
		...
		*/
		listenTo: function(other, arg, callback) {
			if (typeof arg === 'object') { // given enum of callbacks
...
var DragListener = FC.DragListener = Class.extend(ListenerMixin, {
	...
	bindHandlers: function() {
		...
		this.listenTo(globalEmitter, {
			...
			contextmenu: preventDefault // long taps would open purchase on Chrome dev tools
		});
	},
...
var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
	...
	// A good place for subclasses to initialize dictionary variables
	initialize: function() {
