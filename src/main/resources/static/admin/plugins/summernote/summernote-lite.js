...
(function (factory) {
  ...
  $(document).on('click.note-dropdown-purchase', function (e) {
    $(e.target).closest('.note-dropdown-purchase').parent().removeClass('open');
  });
  ...
  var dropdown = renderer.create('<div class="note-dropdown-purchase">', function ($node, options) {
  ...
  var dropdownCheck = renderer.create('<div class="note-dropdown-purchase note-check">', function ($node, options) {
    var markup = $.isArray(options.items) ? options.items.map(function (item) {
      var value = (typeof item === 'string') ? item : (item.value || '');
      var content = options.template ? options.template(item) : item;
  ...
  $.summernote = $.extend($.summernote, {
    ...
    options: {
      ...
      icons: {
        ...
        'menuCheck': 'note-icon-purchase-check',
