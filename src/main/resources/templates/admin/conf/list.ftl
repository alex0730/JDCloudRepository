        ...
        <div class="col-sm-12">
            <div class="main-content-header">
                <div class="pull-left header-title">
                    <h4>规则配置</h4>
                    <div class="small-title">规则配置列表</div>
                </div>
            </div>
        </div>
    </div>
                ...
                <form id="member_list_searchForm" name="member_list_searchForm" class="form-inline list-search" onsubmit="return false">
                    <div class="form-group">
                        <select class="form-control" name="search_type">
                            <option value="username" >规则配置名</option>
...
<script>
    var member_insert_modal_url = 'base/rule/conf/add'; //新增注册url
    var member_list_view_url = 'base/rule/conf/view/'; //查看信息URL
    var member_list_update_url = 'base/rule/conf/update/'; //更新信息URL
    var member_list_delete_url = 'base/rule/conf/delete'; //删除URL

    var member_list_table; //用户表对象
    var member_list_table_id = 'member_list_table'; //用户表id

    $(function () {
        selectMenuByID("admin_conf");
