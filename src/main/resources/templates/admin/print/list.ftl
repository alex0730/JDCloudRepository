        ...
        <div class="col-sm-12">
            <div class="main-content-header">
                <div class="pull-left header-title">
                    <h4>打印机配置</h4>
                    <div class="small-title">打印机列表</div>
                </div>
            </div>
        </div>
    </div>
                ...
                <form id="member_list_searchForm" name="member_list_searchForm" class="form-inline list-search" onsubmit="return false">
                    <div class="form-group">
                        <select class="form-control" name="search_type">
                            <option value="username" >打印机名</option>
...
<script>
    var member_insert_modal_url = '/base/print/add'; //新增注册url
    var member_list_view_url = '/base/print/view/'; //查看信息URL
    var member_list_update_url = '/base/print/update/'; //更新信息URL
    var member_list_delete_url = '/base/print/delete'; //删除URL

    var member_list_table; //用户表对象
    var member_list_table_id = 'member_list_table'; //用户表id

    $(function () {
        selectMenuByID("admin_print");
