...
<div class="container">
    <div class="row" style="margin-top: 50px">
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel panel panel-default" style="padding: 60px 20px;position: relative;left: 122%;">
                <div class="panel-heading">
                    <h3 class="panel-title" style="text-align: center">天津经开区应急物资管理系统</h3>
                </div>
                <div class="panel-body">
                    <form id="loginform" role="form" class="form-vertical form-vertical-small">
                            ...
                            <div class="form-group">
                                <input style="height: 53px" class="form-control validate" placeholder="用户名" name="username" type="text" autofocus data-options="required:true,messages:{required:'请输入用户名'}">
                            </div>

                            <div class="form-group">
                                <input style="height: 53px" class="form-control validate" placeholder="密码" name="password" type="password" value="" data-options="required:true, messages:{required:'请输入密码'}">
                            </div>

                            <div class="form-group">
                                <h3 style="font-size: 16px;color: inherit;position: relative;left: 70%;">忘记密码</h3>
                            </div>
