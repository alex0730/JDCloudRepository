    ...
    <div class="left-sidebar">
        ...
        <div class="user-pannel">
            <div class="pull-left image">
                <img class="img-circle user-left-img">
            </div>
        ...
        <ul class="nav left-menu" id="left-menu">
            ...
            <#list menuList as menu>
                <#if menu.parentId == "0"  && !(menu.sonMenus??)>
                    <li><a href="/${menu.menuUrl}" id="admin_${menu.name}"><i
                                    class="fa fa-dashboard fa-fw"></i> ${menu.cnName}</a></li>
                <#else>
                    <li><a href="javascript:void(0);"><i class="fa fa-dashboard fa-fw"></i>${menu.cnName}<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level hidden">
                            <#list menu.sonMenus as sonMenus>
                                <li><a href="/${sonMenus.menuUrl}" id="admin_${sonMenus.name}">${sonMenus.cnName}</a></li>
                            </#list>
                        </ul>
                    </li>
                </#if>
