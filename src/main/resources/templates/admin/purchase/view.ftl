        ...
        <form id="menu_update_form" role="form" class="viewForm" action="/admin/menu/update" method="post">
            ...
            <table>
                ...
                <tr align="left">
                    ...
                    <td><input type="text" placeholder="" class="searchInput" readonly="true" value="${purchaseOrderInfoModel.purchaseNum}"></td>
                    <td align="right"><span>申购日期&nbsp;&nbsp;&nbsp;</span></td>
                    <td><input type="text" placeholder="" class="searchInput" readonly="true" value="${purchaseOrderInfoModel.purchaseDate}"></td>
                </tr>
                <tr align="left">
                    <td align="right"><span>供应商名称&nbsp;&nbsp;&nbsp;</span></td>
                    <td><input type="text" placeholder="" class="searchInput" readonly="true" value="${purchaseOrderInfoModel.supplierName}"></td>
                    <td align="right"><span>订单总金额&nbsp;&nbsp;&nbsp;</span></td>
                    <td><input type="text" placeholder="" class="searchInput" readonly="true" value="${purchaseOrderInfoModel.orderAmount}"></td>
                </tr>
                <tr align="left">
                    <td align="right"><span>采购订单状态&nbsp;&nbsp;&nbsp;</span></td>
                    <td><input type="text" placeholder="" class="searchInput" readonly="true" value="${purchaseOrderInfoModel.purchasePaymentStatusName}"></td>
                    <td align="right"><span>采购负责人&nbsp;&nbsp;&nbsp;</span></td>
                    <td><input type="text" placeholder="" class="searchInput" readonly="true" value="${purchaseOrderInfoModel.purchasePerson}"></td>
                </tr>
                <tr align="left">
                    <td align="right"><span>采购目的&nbsp;&nbsp;&nbsp;</span></td>
                    <td><input type="text" placeholder="" class="searchInput" readonly="true" value="${purchaseOrderInfoModel.purchasePurposeName}"></td>
                    <td align="right"><span>合同签订时间&nbsp;&nbsp;&nbsp;</span></td>
                    <td><input type="text" placeholder="" class="searchInput" readonly="true" value="${purchaseOrderInfoModel.contractSigningDate}"></td>
                </tr>
                <tr align="left">
                    <td align="right"><span>资金类型&nbsp;&nbsp;&nbsp;</span></td>
                    <td><input type="text" placeholder="" class="searchInput" readonly="true" value="${purchaseOrderInfoModel.capitalTypeName}"></td>
                    <td align="right"><span>采购依据&nbsp;&nbsp;&nbsp;</span></td>
                    <td><input type="text" placeholder="" class="searchInput" readonly="true" value="${purchaseOrderInfoModel.purchaseBasis}"></td>
                </tr>
                </tbody>
            </table>
            <table>
