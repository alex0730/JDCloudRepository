        ...
        <div class="col-sm-12">
            <div class="main-content-header">
                <div class="pull-left header-title">
                    <h4>用户管理</h4>
                    <div class="small-title">用户列表</div>
                </div>
            </div>
        </div>
    </div>
...
<script>
    var user_insert_modal_url = '/sys/auth/user/add'; //新增注册url
    var user_list_view_url = '/sys/auth/user/view/'; //查看信息URL
    var user_list_update_url = '/sys/auth/user/update/'; //更新信息URL
    var user_list_delete_url = '/sys/auth/user/delete/'; //封禁URL
