                ...
                <#--<form id="member_list_searchForm" name="member_list_searchForm" class="form-inline list-search" onsubmit="return false">-->
                    <#--<div class="form-group">-->
                        <#--<select class="form-control" name="search_type">-->
                            <#--<option value="username" >采购单号</option>-->
...
<script>
    var member_insert_modal_url = '/putin/purchase/add'; //新增注册url
    var member_list_view_url = '/putin/purchase/view/'; //查看信息URL
    var member_list_update_url = '/putin/purchase/update/'; //更新信息URL
    var member_list_delete_url = '/putin/purchase/delete'; //删除URL

    var member_list_table; //用户表对象
    var member_list_table_id = 'member_list_table'; //用户表id

    $(function () {
        selectMenuByID("admin_putin");
